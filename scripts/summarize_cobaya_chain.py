"""
This script summarizes a cobaya chain given a prefix.
It prints mean and standard deviation for specified parameters,
and optionally produces a corner plot. 
"""
...
try:
    ...
    print(
        "ERROR: cobaya not installed or failed to import. pip install cobaya",
        file=sys.stderr,
    )
    raise
        ...
        try:
            ...
            try:
                ...
                fig, axes = plt.subplots(
                    len(params), len(params), figsize=(2 * len(params), 2 * len(params))
                )
