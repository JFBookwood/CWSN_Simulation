"""
Convert DESI EDR ELG_HIP galaxies from RA,DEC,Z to Cartesian XYZ coordinates.
"""
...
INPUT_FILES = [
    os.path.join(IN_DIR, "ELG_HIP_N_clustering.dat.fits"),
    os.path.join(IN_DIR, "ELG_HIP_S_clustering.dat.fits"),
]
Z_MIN, Z_MAX = (0.6, 1.6)
