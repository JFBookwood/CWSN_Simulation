"""
Load and preview ELG clustering catalogs from DESI EDR.
"""
...
FILES = [
    os.path.join(BASE_DIR, "ELG_HIP_N_clustering.dat.fits"),
    os.path.join(BASE_DIR, "ELG_HIP_S_clustering.dat.fits"),
]
